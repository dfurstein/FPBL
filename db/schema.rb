...
ActiveRecord::Schema.define(:version => 20140829152556) do
  ...
  add_index "statistics", ["year", "player_id", "franchise_id"], :name => "index_statistics_on_year_and_player_id_and_franchise_id", :unique => true
