...
class LeadersController < ApplicationController
  ...
  def current
    ...
    hitters_averages = hitters_counting.select { |statistic| statistic.PA > games * 3.1 }

    pitchers_counting = Statistic.all_pitchers(@year, ids, 0, 0)
    pitchers_averages = pitchers_counting.select { |statistic| statistic.outs > games * 3}
  ...
  def career
    ...
    hitters_averages = hitters_counting.select { |statistic| statistic.PA > 2500 }

    pitchers_counting = Statistic.all_pitchers(years, ids, 0, 150)
    pitchers_averages = pitchers_counting.select { |statistic| statistic.outs > 750 * 3}
  ...
  def season
    ...
    hitters_counting = years.each_with_object([]) { |year, array| array << Statistic.all_hitters(year, ids, 0, 0) }.flatten
    hitters_averages = hitters_counting.select { |statistic| statistic.PA > 162 * 3.1 }

    pitchers_counting = years.each_with_object([]) { |year, array| array << Statistic.all_pitchers(year, ids, 0, 0) }.flatten
    pitchers_averages = pitchers_counting.select { |statistic| statistic.outs > 162 * 3}
